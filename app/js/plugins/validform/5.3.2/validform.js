...
(function ($, win, undef) {
    ...
    validform.util = {
            ...
            curform.find("[datatype]").each(function () {
                if (tiptype == 2) {
                    if ($(this).parent().next().find(".validform-checktip").length == 0) {
                        $(this).parent().next().append("<span class='validform-checktip' />");
                        $(this).siblings(".validform-checktip").remove();
                    }
                } else if (tiptype == 3 || tiptype == 4) {
                    if ($(this).siblings(".validform-checktip").length == 0) {
                        $(this).parent().append("<span class='validform-checktip' />");
                        $(this).parent().next().find(".validform-checktip").remove();
                    }
                }
            })
        ...
        getNullmsg: function (curform) {
            ...
            var label = curform[0].settings.label || ".validform-label";
        ...
        showmsg: function (msg, type, o, triggered) {
			...
			*/
            ...
            if (type == 1 || triggered == "byajax" && type != 4) {
                msgobj.find(".validform-info").html(msg);
            }
            ...
            if (type == 2 && o.obj) {
                o.obj.parent().next().find(".validform-checktip").html(msg);
                validform.util.cssctl(o.obj.parent().next().find(".validform-checktip"), o.type);
            }

            if ((type == 3 || type == 4) && o.obj) {
                o.obj.siblings(".validform-checktip").html(msg);
    ...
    function creatMsgbox() {
        if ($("#validform-msg").length !== 0) { return false; }
        msgobj = $('<div id="validform-msg"><div class="validform-title">' + tipmsg.tit + '<a class="validform-close" href="javascript:void(0);">&chi;</a></div><div class="validform-info"></div><div class="iframe"><iframe frameborder="0" scrolling="no" height="100%" width="100%"></iframe></div></div>').appendTo("body");//提示信息框;
        msgobj.find("a.validform-close").click(function () {
            msgobj.hide();
            msghidden = true;
            if (errorobj) {
