 ...
 * @Last Modified time: 2017-10-18 15:45:22
 */
'use strict';
        ...
        homeObject: function () {
            ...
            me.method.ajax(JSON.stringify(param), function (data) {
                ...
                var tpl = "<%if(grid.length>0) {%>" +
                    ...
                    "                  <p class=\'big-text text-orange\'><%= data.IncomeRate %><small class=\'fz18\'>%</small></p>" +
                    "                  <p class=\'fz12 text-999\'>预期年化利率</p>" +
                    "              </div>" +
                    "              <div class=\'fjw-progress\'>" +
                    "                  <i class=\'process-bar\'><img style=\'width:<%= progress %>%\' src=\'../../app/image/process.png\'/></i>" +
                    "              </div>" +
                    ...
                    "              </div>" +
                    "              <div class=\'mt30 fjw-btn-lg\'>" +
                    "                  <span rel=\'nofollow\' class=\'btn-text\' data-href=\'/product/detail.html?id=<%= data.Id %>\'>立即抢购</span>" +
                    "              </div>" +
                    "          </a>" +
                    "      </div>" +
                    "   <%}%>" +
