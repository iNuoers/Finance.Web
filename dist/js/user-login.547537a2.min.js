	    ...
	    submit: function () {
	        ...
	        if (validateResult.status) {
	            _user.login(JSON.stringify(req), function (res) {
	                ...
	                // 登录成功 保存状态 cookie
	                _core.cookie.set('F.token', user.token, { path: '/' });
	                _core.cookie.set('F.phone', user.member.phone, { path: '/' });
	                _core.cookie.set('F.avator', user.member.headPhoto, { path: '/' });

	                _core.storage.setItem('f_ui_cache', res);
